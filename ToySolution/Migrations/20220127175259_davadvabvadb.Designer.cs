...
namespace ToySolution.Migrations
{
    ...
    [Migration("20220127175259_davadvabvadb")]
    partial class davadvabvadb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToySolution.Models.Entities.Membership.StoreRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("StoreRole", "Membership");
                });

            modelBuilder.Entity("ToySolution.Models.Entities.Membership.StoreUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("StoreUser", "Membership");
                });
            ...
            modelBuilder.Entity("ASP.NetCV.Models.Entities.Membership.RoleClaim", b =>
                {
                    b.HasOne("ToySolution.Models.Entities.Membership.StoreRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ASP.NetCV.Models.Entities.Membership.UserClaim", b =>
                {
                    b.HasOne("ToySolution.Models.Entities.Membership.StoreUser", null)
                        .WithMany()
